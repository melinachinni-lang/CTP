  ...
  return (
    <>
      <style>{`
        ...
        .ctp-editor p{margin:0 0 10px;color:#3A3A3A;line-height:1.7}
        ...
        .ctp-preview h2{font-size:1.2rem;font-weight:600;color:#0A0A0A;margin:14px 0 6px}
        .ctp-preview h3{font-size:1.05rem;font-weight:600;color:#0A0A0A;margin:10px 0 4px}
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={handleSave} className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium transition-all" style={{ backgroundColor: saveSuccess ? '#166534' : '#3D5E28', color: '#FFFFFF', fontFamily: 'var(--font-body)' }} onMouseEnter={e => { if (!saveSuccess) e.currentTarget.style.backgroundColor = '#2E4A1E'; }} onMouseLeave={e => { if (!saveSuccess) e.currentTarget.style.backgroundColor = saveSuccess ? '#166534' : '#3D5E28'; }}>
