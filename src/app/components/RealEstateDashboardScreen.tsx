...
const RESERVAS_TABS = [
  { id: 'solicitudes', label: 'Solicitudes de reserva' },
  { id: 'valores',     label: 'Valores de reserva' },
];

const RESERVAS_DESCRIPCIONES: Record<string, string> = {
  solicitudes: 'Revisa y confirma los comprobantes de pago enviados por los compradores.',
  valores:     'Administra los montos de reserva asociados a tus parcelas y proyectos.',
};
  ...
  const plans = [
    {
      ...
      name: 'Bronce',
      price: '$150.000',
      description: 'Hasta 10 publicaciones activas con vigencia permanente',
      features: [
        { name: 'Hasta 10 parcelas o proyectos activos', included: true },
        { name: 'Visibilidad media en el portal', included: true },
        { name: 'Aviso sin vencimiento', included: true },
    ...
    },
    {
      ...
      name: 'Plata',
      price: '$300.000',
      description: 'Hasta 30 publicaciones con alta visibilidad',
      features: [
        { name: 'Hasta 30 parcelas o proyectos activos', included: true },
        ...
        { name: 'Mapa interactivo con delimitación del terreno', included: true },
        { name: 'Simulador de financiamiento integrado', included: true },
        { name: '10 avisos destacados al mes', included: true },
        { name: 'Tus publicaciones en portada del portal (rotativo)', included: true },
        { name: 'Landing page exclusiva para tu inmobiliaria', included: true },
        { name: 'Estadísticas de visitas y reportería', included: true },
        { name: 'Exportación a Google Sheet', included: true },
      ]
    },
    {
      ...
      name: 'Oro',
      price: '$600.000',
      description: 'Publicaciones ilimitadas y máxima exposición',
      features: [
