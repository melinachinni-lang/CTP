      ...
      <main className="relative pt-20 sm:pt-24 md:pt-28" style={{ backgroundColor: 'var(--hero-background)' }}>
        ...
        <section className="relative py-12 sm:py-16 md:py-32 pb-24 sm:pb-32 md:pb-52 overflow-hidden" style={{ backgroundColor: 'var(--hero-background)' }}>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 md:px-6 z-10">
            ...
            {/* Buscador Unificado */}
            <div className="relative mb-8 sm:mb-10 md:mb-12 bg-white p-4 sm:p-6 md:p-8 w-full shadow-[0_8px_30px_rgba(0,0,0,0.06)] rounded-[20px] sm:rounded-[24px] border-2 border-gray-200 transition-all duration-300">
              <button
                className="absolute top-3 right-3 w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 transition-all"
