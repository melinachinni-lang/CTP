      ...
      >
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div>
            ...
            <div className="rounded-xl p-3 flex items-start gap-2 mt-3" style={{ backgroundColor: '#FEF3C7', border: '1px solid #FDE68A' }}>
        ...
        <div className="px-6 py-4 border-t" style={{ borderColor: '#E5E5E5' }}>
          <button
            ...
            className="w-full py-3 rounded-full transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
              fontFamily: 'var(--font-body)',
            ...
            onMouseEnter={e => { if (isFormValid) e.currentTarget.style.backgroundColor = '#01533E'; }}
            onMouseLeave={e => { if (isFormValid) e.currentTarget.style.backgroundColor = '#006B4E'; }}
          >
