...
export function FlujoCompraModal({ isOpen, onClose, parcelaNombre, precio, tipoCompra, onEstadoChange }: FlujoCompraModalProps) {
  ...
  return ReactDOM.createPortal(
    ...
    <div className="fixed inset-0 z-[9990] flex items-center justify-center p-4"
      ...
      {/* Modal */}
      <div className={`bg-white rounded-2xl shadow-2xl w-full ${paso === 'aviso' ? 'max-w-sm' : 'max-w-2xl'} relative flex flex-col`} style={{ maxHeight: '90vh' }}>
        ...
        <div className="px-6 py-6" style={{ overflowY: 'auto', flex: 1 }}>
          ...
          {/* ── AVISO ── */}
          {paso === 'aviso' && !enviado && (
            <div className="flex flex-col items-center space-y-5 text-center py-2">
              ...
              <div className="rounded-xl p-4 text-left space-y-2.5 w-full" style={{ backgroundColor: '#F9FAFB', border: '1px solid #E5E5E5' }}>
