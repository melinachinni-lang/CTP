...
interface PlanesBrokersPageProps {
...
export function PlanesBrokersPage({ onNavigate, isLoggedIn = false, currentUser, onLogout }: PlanesBrokersPageProps) {
  ...
  const planes = [
    {
      ...
      destacado: false,
      caracteristicas: [
        { incluido: true, texto: '5 publicaciones activas como mínimo' },
    ...
    },
    {
      ...
      destacado: true,
      caracteristicas: [
        { incluido: true, texto: '10 publicaciones activas como mínimo' },
    ...
    },
    {
      ...
      destacado: false,
      caracteristicas: [
        { incluido: true, texto: '25 publicaciones activas como mínimo' },
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg" style={{ color: '#6B6B6B', maxWidth: '700px', margin: '0 auto' }}>
              Elige el plan que mejor se adapte a tu perfil y potencia tu actividad como broker
            </p>
          ...
          <div className="mt-16 text-center">
            <div className="bg-white rounded-3xl p-8 max-w-4xl mx-auto">
              ...
              <p className="mb-6" style={{ color: '#6B6B6B' }}>
                Si trabajas con un volumen alto de propiedades o necesitas funcionalidades específicas, contáctanos para crear un plan a medida.
              </p>
              <button
