    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-screen-xl mx-auto">
      ...
      <div className="flex items-start justify-between gap-3 mb-6">
        <div className="flex items-start gap-3 min-w-0">
          <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#E8F5EE' }}>
            <Sparkles className="w-4 h-4 md:w-5 md:h-5" style={{ color: '#006B4E' }} />
          </div>
          <div className="min-w-0">
            <h2 className="text-base md:text-lg font-semibold leading-tight" style={{ color: '#0A0A0A', fontFamily: 'var(--font-heading)' }}>
              Insights y recomendaciones IA
            </h2>
            <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
              <Clock className="w-3 h-3 flex-shrink-0" style={{ color: '#737373' }} />
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <button
            ...
            disabled={isLoading}
            className="flex items-center gap-1.5 px-2.5 md:px-3 py-2 text-xs transition-all disabled:opacity-50 whitespace-nowrap"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 md:px-3 py-2 text-xs transition-all whitespace-nowrap"
            style={{
          ...
          >
            ...
            <span className="hidden sm:inline">Configurar scoring</span>
          </button>
        </div>
      </div>
      ...
      <div
        ...
        style={{ maxHeight: showScoringConfig ? '600px' : '0', opacity: showScoringConfig ? 1 : 0, marginBottom: showScoringConfig ? '24px' : '0' }}
      >
        <div className="rounded-2xl p-4 md:p-5" style={{ backgroundColor: '#F9FAFB', border: '1px solid #E5E5E5' }}>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
            ...
            <span className="text-xs px-2 py-1 rounded-full font-medium self-start sm:self-auto flex-shrink-0" style={{ backgroundColor: '#FEF3C7', color: '#92400E' }}>
