...
interface ComprarProyectoModalProps {
  isOpen: boolean;
  onClose: () => void;
  onComprarAhora: () => void;
  onReservar: () => void;
...
export function ComprarProyectoModal({
  isOpen,
  onClose,
  onComprarAhora,
  onReservar,
  proyectoNombre
}: ComprarProyectoModalProps) {
      ...
      >
        ...
        <div className="px-6 py-6">
          <p style={{
            ...
            Elige cómo quieres continuar con la adquisición de este proyecto:
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p style={{
                    ...
                    Reserva con una seña y asegura tu proyecto mientras completas el proceso
                  </p>
                </div>
              </div>
            </button>
