import svgPaths from "./svg-tn2imjavhh";
...
export default function Button() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[8px] relative rounded-[200px] size-full" data-name="Button">
      <Component3D />
